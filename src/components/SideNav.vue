<template>
  <div class="lg:w-1/5 border-r border-lighter px-2 lg:px-8 py-2 flex flex-col justify-between">
    ...
    <div class="lg:text-left text-center">
      ...
      <!-- menu -->
      <button v-for="tab in tabs" @click="selectedId = tab.id" :class="['flex', 'items-center', 'py-2', 'px-4', 'mb-3', 'hover:bg-lightblue', 'rounded-full', 'lg:mr-auto', 'hover:text-blue', tab.id === selectedId ? 'text-blue' : '']">
