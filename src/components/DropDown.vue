<template>
  <div class="absolute bottom-0 left-0 w-64 shadow-md border-lightest bg-white mb-16 rounded-lg">
    ...
    <button class="flex items-center w-full transition hover:bg-lightest py-2 px-4">
    ...
    <button class="w-full text-left transition hover:bg-lightest border-t border-lighter p-3">
